...
//        String s = "  Hello World  ";
        ...
        // 分解字符串:根据指定的规则对字符串进行分解，可以将一个完整字符串，分解成几个部分
//        String[] s1 = s.split(",");
...
//        }
        ...
        // TODO 字符串的替换,
        // String s = "Hello World World";  // Hello Java Java
        // 替换
        //   System.out.println(s.replace("World zhangsan", "Java"));

        // replaceAll 按照指定的规则进行替换
        // System.out.println(s.replaceAll("Hello|zhangsan", "Java"));
...
//        System.out.println(s.charAt(1));
        ...
        // index of 方法用以获取数据在字符串中第一次出现的位置
        // System.out.println(s.indexOf("Hello"));

        // index of 方法用以获取数据在字符串中最后一次出现的位置
        // System.out.println(s.lastIndexOf("Hello"));


        // 是否包含指定的字符串，返回布尔类型
//        System.out.println(s.contains("Hello1"));

        // 判断当前的字符串是以指定数据开头
//        System.out.println(s.startsWith("Hello"));
//        System.out.println(s.endsWith("World"));

        // 判断字符串是否为空，空格其实是一个特殊字符，所以看不到，但是不为空
